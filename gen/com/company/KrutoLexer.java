// Generated from C:/Users/HP/IdeaProjects/KursCompiller/src/com/company\KrutoLexer.g4 by ANTLR 4.10.1
package com.company;
...
public class KrutoLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"WHILE", "DO", "BREAK", "CONTINUE", "IF", "THEN", "VAR", "INT", "FLOAT", 
			"FUNC", "VOID", "RETURN", "PRINT", "LPAREN", "RPAREN", "LBRACE", "RBRACE", 
			"LBRACK", "RBRACK", "SEMI", "COLON", "COMMA", "DOT", "ASSIGN", "GT", 
			"LT", "BANG", "EQUAL", "LE", "GE", "NOTEQUAL", "AND", "OR", "ADD", "SUB", 
			"MUL", "DIV", "CARET", "DECIMAL_LITERAL", "FLOAT_LITERAL", "IDENTIFIER", 
			"ExponentPart", "Digits", "LetterOrDigit", "Letter", "WS", "COMMENT"
		};
	}
	...
	public KrutoLexer(CharStream input) {
		super(input);
		_interp = new LexerATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	@Override
	public String getGrammarFileName() { return "KrutoLexer.g4"; }
